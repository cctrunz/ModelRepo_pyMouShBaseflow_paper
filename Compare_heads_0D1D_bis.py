...
moulin_radii = 0.4 #m (based out of the highest radius when running moush for JEME)
ice_thickness = 500 #m
initial_head = 500 #m
initial_radius = 0.8
initial_subglacial_area = np.pi*initial_radius**2/2 #m
...
plt.subplot(3,1,3)
plt.plot(time/secinday,moulin_evol.dict['subglacial_radius'],label='0D - evol')
plt.plot(time/secinday, moulin_fix.dict['subglacial_radius'],linestyle='--',label='0D - fix')
