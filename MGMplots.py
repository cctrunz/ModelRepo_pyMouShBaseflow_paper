        ...
        for z_break in [500,heq]:
            ...
            for idx,t_start in enumerate(time_figure):
                ...
                moulin.plot_MGM(fig,t_start, t_end,
                                  ...
                                  SC_lim = SC_lim,
                                  Q_fixed = False)
                plt.savefig(path+'MGM_top%d_bottom%d_zbreak%d_no%d.png'%(r_top,r_bottom,z_break,idx),dpi=300)
                plt.close(fig)
        del moulin
    ...
    for main in [1.,4.,8.]:
        ...
        for idx,t_start in enumerate(time_figure):
            ...
            losange.plot_MGM(fig,t_start, t_end,
                              ...
                              SC_lim = SC_lim,
                              Q_fixed = False)
            plt.savefig(path+'Losange_middle%d_main%d_no%d.png'%(middle,main,idx))
            plt.close(fig)    
    del losange
