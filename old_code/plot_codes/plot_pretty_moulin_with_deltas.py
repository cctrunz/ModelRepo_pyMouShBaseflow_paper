...
ax1 = fig1.add_subplot(grid[0, 0:4])
ax2 = fig1.add_subplot(grid[0, 5:9], sharey=ax1)
ax3 = fig1.add_subplot(grid[0, 7:11], sharey=ax1)
ax4 = fig1.add_subplot(grid[0, 9:13], sharey=ax1)
ax5 = fig1.add_subplot(grid[0, 11:15], sharey=ax1)
ax6 = fig1.add_subplot(grid[0, 13:17], sharey=ax1)

    

def live_plot(Mx_upstream,Mx_downstream,dTM,dPD,dC_major,dC_minor,dE_major,dE_minor,dr_major,dr_minor,dGlen,t,hw,z,idx,wet,mts_to_cmh,time,H):
