...
ax7 = fig1.add_subplot(grid[2, 0:7]) 
ax8 = ax7.twinx()
ax9 = fig1.add_subplot(grid[3, 0:7])  
ax10 = fig1.add_subplot(grid[3, 0:7]) 

dlim = 15
dbound = 15
dtick = [-8,-6,-4,-2,0,2,4,6,8]
    

def live_plot(Mx_upstream,Mx_downstream,dTM,dC_major,dC_minor,dE_major,dE_minor,dr_major,dr_minor,dGlen,t,hw,SCs,z,Qin,Qout,idx,wet,mts_to_cmh,time,H):
    ...
    #MELT
    ax2.clear()
    ax2.plot(dTM*mts_to_cmh,z,color='black') 
